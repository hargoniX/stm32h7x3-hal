...
use crate::gpio::{AF5, AF6, AF7, AF8, Output, Input, PushPull};
...
unsafe impl MisoPin<SPI1> for PA6<Input<PushPull>, AF5> {}
unsafe impl MisoPin<SPI1> for PG9<Input<PushPull>, AF5> {}
unsafe impl MisoPin<SPI1> for PB4<Input<PushPull>, AF5> {}

// All MISO pins for SPI2
unsafe impl MisoPin<SPI2> for PC2<Input<PushPull>, AF5> {}
unsafe impl MisoPin<SPI2> for PB14<Input<PushPull>, AF5> {}
unsafe impl MisoPin<SPI2> for PI2<Input<PushPull>, AF5> {}

unsafe impl MisoPin<SPI3> for PC11<Input<PushPull>, AF6> {}
unsafe impl MisoPin<SPI3> for PB4<Input<PushPull>, AF6> {}

unsafe impl MisoPin<SPI4> for PE5<Input<PushPull>, AF5> {}
unsafe impl MisoPin<SPI4> for PE13<Input<PushPull>, AF5> {}

unsafe impl MisoPin<SPI5> for PF8<Input<PushPull>, AF5> {}
unsafe impl MisoPin<SPI5> for PH7<Input<PushPull>, AF5> {}
unsafe impl MisoPin<SPI5> for PJ11<Input<PushPull>, AF5> {}

unsafe impl MisoPin<SPI6> for PA6<Input<PushPull>, AF8> {}
unsafe impl MisoPin<SPI6> for PG12<Input<PushPull>, AF5> {}
unsafe impl MisoPin<SPI6> for PB4<Input<PushPull>, AF8> {}
